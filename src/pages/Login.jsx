    ...
    >
      ...
      >
        ...
        <div className="mt-2 flex flex-col gap-3">
          {!useEmail ? (
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="h-5 w-5">
                <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.5 31.7 29.1 35 24 35c-6.1 0-11-4.9-11-11s4.9-11 11-11c2.8 0 5.4 1.1 7.4 2.8l5.7-5.7C33.1 7 28.8 5 24 5 12.9 5 4 13.9 4 25s8.9 20 20 20c10 0 19-7.3 19-20 0-1.4-.1-2.8-.4-4.5z"/>
                <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.6 16.2 19 13 24 13c2.8 0 5.4 1.1 7.4 2.8l5.7-5.7C33.1 7 28.8 5 24 5 16.5 5 9.9 9.1 6.3 14.7z"/>
                <path fill="#4CAF50" d="M24 45c5 0 9.6-1.9 13.1-5.1l-6-4.9C29.1 35 26.7 36 24 36c-5.1 0-9.4-3.3-11-7.8l-6.7 5.2C9.9 40.9 16.5 45 24 45z"/>
                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1 2.9-3.2 5.1-6.2 6.1l6 4.9C37.6 36.9 40 31.7 40 25c0-1.6-.2-3.2-.4-4.5z"/>
              </svg>
          ...
          <button
            type="button"
            onClick={() => { setUseEmail(!useEmail); setErr(""); setMsg(""); }}
            className="
        ...
        {/* Messages */}
        {err && <p className="mt-4 text-sm text-rose-600 dark:text-rose-400">{err}</p>}
